...
Antes de iniciar, é necessário garantir que os seguintes pacotes de \textit{software} estejam instalados no sistema (preferencialmente um ambiente Linux, como o Ubuntu):
