...
O modelo de \textit{wrapper} implementado neste capítulo, juntamente com as adaptações de \textit{frontend}, estabelece a base de interoperabilidade necessária para o desenvolvimento em RL. Essa arquitetura foi projetada para ser adaptável: o desenvolvedor pode escolher a arquitetura desejada para gerar o \textit{firmware} (ex: ARM Cortex-M/STM32), desde que o Robcmp e o TFLM ofereçam suporte à plataforma. Para isso, basta compilar o \textit{wrapper} e a biblioteca do TFLM para a arquitetura específica, garantindo a portabilidade do sistema. As próximas etapas se concentram na validação funcional e na análise comparativa de eficiência da solução.
