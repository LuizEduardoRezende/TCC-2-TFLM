...
Neste capítulo, são apresentadas publicações relacionadas a este trabalho, que abordam temas como, decisões de design do TFLM e ferramentas para \textit{TinyML} e \textit{Edge AI}. Esse material acadêmico foi escolhido a partir de uma revisão narrativa de literatura (RNL). Além disso também será abordado implementações práticas de wrappers do framework TFLM para o desenvolvimento de software para sistemas embarcados.
