...
Em relação ao suporte a diferentes MCUs, este trabalho pode ser considerado de alto nível, por se basear no TFLM (que já oferece suporte a diversas arquiteturas) e na RL, independente do \textit{hardware}. Atualmente, o trabalho está validado em MCUs da família STM32, mas a expectativa é que ele possa ser facilmente adaptado para outras arquiteturas suportadas tanto pelo TFLM quanto pela RL. Isso ocorre porque o \textit{wrapper} desenvolvido é independente do \textit{hardware}, sendo o único fator limitante o suporte da RL às diferentes plataformas. Esse suporte, por sua vez, é constantemente ampliado com o desenvolvimento contínuo da RL.
