...
\begin{figure}[H] % Você pode usar [H], [tp], etc.
\centering
\begin{lstlisting}
...
\end{lstlisting}
\caption{Exemplo de código com a nova sintaxe para inferência de um modelo tflite.}
\label{fig:nova_sintaxe}
\end{figure}
