...
A \hyperref[notebook-tamanho]{Tabela~\ref*{notebook-tamanho}} apresenta o tamanho do binário final gerado para cada teste unitário, enquanto a \hyperref[comparativo]{Tabela~\ref{comparativo}} exibe o tempo de execução médio obtido em cada um. Ambos os testes foram realizados na máquina de desenvolvimento. 
...
Apesar do código em RL possuir mais caracteres por conta da ausência de um sistema de arquvios para incluir os dados do modelo e dados de entrada diretamente(como é feito em C++), o número de linhas de código é significativamente menor, o que facilita a leitura e manutenção do código.
