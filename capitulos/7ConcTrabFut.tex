...
Pode-se concluir que o desenvolvimento do \textit{wrapper} e da biblioteca \texttt{ai.tflm} representa uma base sólida para o desenvolvimento de aplicações TinyML em RL. Isso permite que aplicações de ML sejam desenvolvidas para dispositivos embarcados com recursos limitados, aproveitando as capacidades do TFLM e também da RL que inclui desenvolvimento de firmware com baixo acoplamento, alta coesão, elevada manutenibilidade e abstração de hardware.
